...
$fields= '';
if(isset($_POST['Fields'])) $fieldarray = $_POST['Fields'];
if(empty($fieldarray)) {
...
$fetchquery1 = "SELECT $fields FROM $fetchtable1 JOIN $fetchtable2 ON $fetchtable1.JobId=$fetchtable2.JobId JOIN $fetchtable3 ON $fetchtable1.ProfessionId=$fetchtable3.ProfessionId WHERE Employee.JobId='11'";
...
<div id="wrapper">
	...
	?>
    <div id="content">
    	<form action="lookupnurse.php" method="POST">
        	Look For: *<br />
            ...
            <table>
            	<tr>
                    ...
                    <td><input type="checkbox" name="Fields[]" value="LastName AS 'Last Name'" checked/> Last Name</td>checked/> Date of Birth</td>
        	...
        	<br /><br />
            <input type="submit" value="Search Nurse"/>
		...
		echo '
			<table border="1">
				<tr>
					<th colspan="'.$n.'">Nurses in our Hospital:</th>
				</tr>
				<tr>';
				$counter=0;
				while($counter<$n) {
