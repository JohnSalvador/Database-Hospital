...
if(isset($_POST['search'])&&!empty($_POST['search'])&&isset($_POST['socialsecurity'])&&!empty($_POST['socialsecurity'])){
	...
	$searchedfield = " AND(LastName LIKE '%$search%' AND SocialSecurity='$socialsecurity'";
...
<div id="wrapper">
    ...
    <div id="content">
    	<form action="myrecord.php" method="POST">
        	Last Name: *<br />
            <input type="text" name="search" size="30" maxlength="20"/> <br /><br />
            SocialSecurity: *<br />
